...
if __name__ == '__main__':
    ...
    n_cells = 44
    bypass_diodes = 22
    module_name = 'MiaSole_Flex_01_70N'  # make sure the name is stated as in the database
    number_of_subcells = 2
    start_module = 111
    end_module = 114
    ...
    module_lookup_table_path = os.path.join(current_directory, r'data\lookup_empty.pkl')
    epw_path = os.path.join(current_directory, r'data\Zurich.epw')
    module_temp_results = os.path.join(current_directory, 'results')
    database_path = os.path.join(current_directory, r'data\sam-library-cec-modules-2015-6-30.csv')
