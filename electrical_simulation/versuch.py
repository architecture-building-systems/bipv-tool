...
module_path_1 = r'F:\Paper\Module-simulations\longi\normal\module73.pkl'
module_path_2 = r'F:\Paper\Module-simulations\longi\unbypassed\module73.pkl'
module_path_3 = r'F:\Paper\Module-simulations\orthogonal\electrical_simulation\results\string2.pkl'
module_path_4 = r'F:\Paper\Module-simulations\orthogonal\electrical_simulation_unbypassed\results\string2.pkl'
...
plt.title("Module IV-curve for Orthogonal Cell Orientation")
...
# ax.plot(module1_iv[hour_of_year][1],module1_iv[hour_of_year][0], label='with bypass diodes', color='firebrick', linestyle="-.")
# ax.plot(module2_iv[hour_of_year][1],module2_iv[hour_of_year][0], label='without bypass diodes', color='navy', linestyle="--")
ax.plot(module3_iv[hour_of_year][1],module3_iv[hour_of_year][0], label='with bypass diodes', color='firebrick', linestyle="-.")
ax.plot(module4_iv[hour_of_year][1],module4_iv[hour_of_year][0], label='without bypass diodes', color='navy', linestyle="--")
