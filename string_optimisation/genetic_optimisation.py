...
def run_optimisation(cxpb=0.9, mutpb=0.5, number_of_generations=1000, population_size=500):
    ...
    while generation < number_of_generations:
        ...
        # Evaluate the individuals with an invald fitness
        ...
        if generation==number_of_generations:
            ...
            pd.DataFrame(generation_history).to_csv(r"C:\Users\walkerl\Desktop\temp_stuff\Images\history%s.csv" % (str(int(100*cxpb)) + "_" +str(int(100*mutpb))))
